# Install script for directory: /home/kota/realsensePCL/pcl
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/kota/realsensePCL/pcl/rs-pcl")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/rs-pcl" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/rs-pcl")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/rs-pcl"
